        ...
        <div className="max-w-5xl mx-auto rounded-2xl p-6 sm:p-10 border bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-800 shadow-xl">
          ...
          <section className="text-sm leading-relaxed text-gray-700 dark:text-gray-300">
            <p>
              ...
              encourages you to do absolutely nothing important. Instead of
              pushing you to focus, it invites you to take a breath, relax, and
              enjoy the art of doing less.
            </p>
            <p>
              Feel like slowing down for no good reason? You are in the right
              place.
            </p>
            <br />
            <p>
