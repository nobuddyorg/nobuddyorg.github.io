    ...
    >
      ...
      >
        <circle
          ...
          cy="61"
          r="111"
          className="fill-[#FCFAFF] dark:fill-[#1e1b4b]"
        />
        <circle
          cx="244"
          cy="106"
          r="139"
          className="fill-[#F9F0FF] dark:fill-[#312e81]"
        />
        <circle
          cx="400"
          cy="150"
          r="139"
          className="fill-[#EEE4FE] dark:fill-[#3730a3]"
        />
        <circle
          cx="316"
          cy="305"
          r="139"
          className="fill-[#DDD6FE] dark:fill-[#4f46e5]"
        />
        <circle
          cx="170"
          cy="319"
          r="139"
          className="fill-[#CABFFD] dark:fill-[#6366f1]"
        />
      </svg>
